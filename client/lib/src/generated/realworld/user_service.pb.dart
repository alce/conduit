...
class ToggleFollowUserRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ToggleFollowUserRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'realworld'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'username')
    ..hasRequiredFields = false
  ;

  ToggleFollowUserRequest._() : super();
  factory ToggleFollowUserRequest({
    $core.String? username,
  }) {
    final _result = create();
    if (username != null) {
  ...
  factory ToggleFollowUserRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ToggleFollowUserRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ToggleFollowUserRequest clone() => ToggleFollowUserRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ToggleFollowUserRequest copyWith(void Function(ToggleFollowUserRequest) updates) => super.copyWith((message) => updates(message as ToggleFollowUserRequest)) as ToggleFollowUserRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ToggleFollowUserRequest create() => ToggleFollowUserRequest._();
  ToggleFollowUserRequest createEmptyInstance() => create();
  static $pb.PbList<ToggleFollowUserRequest> createRepeated() => $pb.PbList<ToggleFollowUserRequest>();
  @$core.pragma('dart2js:noInline')
  static ToggleFollowUserRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ToggleFollowUserRequest>(create);
  static ToggleFollowUserRequest? _defaultInstance;
